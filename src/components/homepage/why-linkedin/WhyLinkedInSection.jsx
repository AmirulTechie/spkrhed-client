    ...
    <section className="relative overflow-hidden py-[clamp(64px,9.7222vw,140px)]">
      ...
      <div className="relative mx-auto max-w-300 px-[clamp(24px,5.5556vw,80px)] text-center">
        ...
        <div className="mt-25 grid grid-cols-1 items-center sm:grid-cols-[1fr_auto_1fr]">
          <p className="font-anton-sc max-w-59.75 ml-auto mr-[clamp(24px,11.1111vw,160px)] text-[clamp(22px,2.7778vw,40px)] uppercase leading-[100%] text-white text-left">
            No promotions folder,<br></br> no buried requests tab.
          </p>
          ...
          >
            <span className="font-anton-sc text-[clamp(24px,20.57vw,70px)] text-[#AC40FF]">
              01
            </span>
          </div>

          <p className="font-poppins ml-[clamp(16px,6.3194vw,91px)] w-full max-w-xl text-[clamp(16px,1.6667vw,24px)] font-medium leading-[97%] text-[#b7b7b7] text-left">
