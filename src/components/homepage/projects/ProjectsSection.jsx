    ...
    >
      <div className="relative mx-auto max-w-325 px-[clamp(24px,5.5556vw,80px)]">
        ...
        <div className="mt-[clamp(96px,15.2778vw,220px)] flex flex-col gap-6 lg:flex-row lg:items-end lg:justify-between">
          <h2
            ref={headingRef}
            className="font-anton-sc text-[clamp(45px,7vw,96px)] uppercase leading-[0.97] text-white"
          >
            <SproutLine>
          ...
          <p
            ref={descriptionRef}
            className="max-w-96 font-poppins text-[clamp(16px,2.22vw,32px)] font-medium leading-[1.05] text-[#b7b7b7]"
          >
            {DESCRIPTION_TEXT}
          </p>
        </div>
